...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _initApp = __webpack_require__(745);
	
	var _config = __webpack_require__(739);
	...
	(0, _initApp.initUnauthenticatedApp)(_config2.default, [], function () {
	  ...
	  var cvControllerService = SYMPHONY.services.subscribe("citibot:controller");
	  // The application service that will handle the filter on UI extensions
	  var cvFilterService = SYMPHONY.services.register("cv:filter");
	
	  uiService.registerExtension('hashtag', 'cv-assistant', 'citibot:controller', {
	    label: 'SearchCV',
	    data: { 'datetime': Date() }
	  });
	});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Axios = __webpack_require__(583);
	...
	axios.CancelToken = __webpack_require__(602);
	axios.isCancel = __webpack_require__(598);
	
	// Expose all/spread
	axios.all = function all(promises) {
	  return Promise.all(promises);
	};
	axios.spread = __webpack_require__(603);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var utils = __webpack_require__(581);
	var normalizeHeaderName = __webpack_require__(585);
	...
	function getDefaultAdapter() {
	  ...
	  if (typeof XMLHttpRequest !== 'undefined') {
	    ...
	    adapter = __webpack_require__(586);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var buildURL = __webpack_require__(590);
	var parseHeaders = __webpack_require__(591);
	var isURLSameOrigin = __webpack_require__(592);
	var createError = __webpack_require__(588);
	var btoa = typeof window !== 'undefined' && window.btoa && window.btoa.bind(window) || __webpack_require__(593);
	...
	module.exports = function xhrAdapter(config) {
	  return new Promise(function dispatchXhrRequest(resolve, reject) {
	    ...
	    if (utils.isStandardBrowserEnv()) {
	      var cookies = __webpack_require__(594);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var enhanceError = __webpack_require__(589);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var isCancel = __webpack_require__(598);
	var defaults = __webpack_require__(584);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.initUnauthenticatedApp = exports.initApp = undefined;
	
	var _registerApplication = __webpack_require__(746);
	
	var _apiCalls = __webpack_require__(751);
	
	var _authService = __webpack_require__(753);
	...
	*/
	var initApp = exports.initApp = function initApp(config, enrichers) {
	  var userInfo = {};
	  var tokenA = '';
	  ...
	  var authenticateApplication = function authenticateApplication(podInfo) {
	    return (0, _apiCalls.authenticateApp)(podInfo.pod);
	  };
	  ...
	  var registerAuthenticatedApp = function registerAuthenticatedApp(appTokens) {
	    ...
	    return (0, _registerApplication.registerApplication)(config, appData, enrichers);
	  };
	
	  var validateAppTokens = function validateAppTokens(symphonyToken) {
	    return (0, _apiCalls.validateTokens)(tokenA, symphonyToken.tokenS);
	  };
	  ...
	  var validateJwtToken = function validateJwtToken(jwt) {
	    userInfo.jwt = jwt;
	    return (0, _apiCalls.validateJwt)(jwt);
	  };
	
	  var cacheJwt = function cacheJwt(response) {
	    userInfo.userId = response.data;
	
	    (0, _authService.cacheUserInfo)(userInfo);
	  };
	...
	* @return       SYMPHONY.remote.hello       returns a SYMPHONY remote hello service.
	*/
	var initUnauthenticatedApp = exports.initUnauthenticatedApp = function initUnauthenticatedApp(config, enrichers, finishCallback) {
	  // create our own service
	  SYMPHONY.services.register(config.appId + ':controller');
	
	  var registerApp = function registerApp() {
	    return (0, _registerApplication.registerApplication)(config, config.appId, enrichers);
	  };
	
	  SYMPHONY.remote.hello().then(registerApp).then(finishCallback).fail(function (e) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.registerApplication = undefined;
	
	var _utils = __webpack_require__(747);
	
	var _registerEnricher = __webpack_require__(748);
	...
	var registerExtension = function registerExtension(config) {
	    var controllerName = config.appId + ':controller';
	    var uiService = SYMPHONY.services.subscribe('ui');
	    var dialogsService = SYMPHONY.services.subscribe('dialogs');
	    uiService.registerExtension('app-settings', config.appId, controllerName, {
	        label: 'Configure'
	    });
	};
	
	var registerModule = function registerModule(config) {
	    var controllerName = config.appId + ':controller';
	    var controllerService = SYMPHONY.services.subscribe(controllerName);
	    ...
	    controllerService.implement({
	        ...
	        trigger: function trigger() {
	            ...
	            modulesService.show(config.appId, { title: config.appTitle }, controllerName, url.join(''), { canFloat: true });
	        }
	    });
	};
	 ...
	 * @return       SYMPHONY.remote.hello       returns a SYMPHONY remote hello service.
	 */
	var registerApplication = exports.registerApplication = function registerApplication(config, appData, enrichers) {
	    var controllerName = config.appId + ':controller';
	
	    var exportedDependencies = (0, _registerEnricher.initEnrichers)(enrichers);
	    exportedDependencies.push(controllerName);
	
	    var register = function register(data) {
	        (0, _registerEnricher.registerEnrichers)(enrichers);
	    ...
	    return SYMPHONY.application.register(appData, dependencies, exportedDependencies).then(register);
	};
	    ...
	    instances.map(function (instance) {
	      if (instance.streamType === 'CHATROOM') {
	        instance.streams.map(function (stream) {
	          ...
	          if (userRooms.filter(function (userRoom) {
	            return stream === userRoom.threadId;
	          }).length > 0) {
	            instance.postingLocationRooms.push(userRooms.filter(function (userRoom) {
	              return stream === userRoom.threadId;
	            })[0]);
	          }
	        });
...
/***/ (function(module, exports) {
	...
	*/
	var initEnrichers = exports.initEnrichers = function initEnrichers(enrichers) {
	  if (enrichers !== undefined) {
	    enrichers.forEach(function (enricher) {
	      enricher.init();
	    });
	
	    return enrichers.map(function (enricher) {
	...
	* @params       enrichers                   array of Enrichers to be registered in the application
	*/
	var registerEnrichers = exports.registerEnrichers = function registerEnrichers(enrichers) {
	  if (enrichers !== undefined) {
	    enrichers.forEach(function (enricher) {
	      enricher.register();
	    });
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if("function"=='function'&&_typeof(__webpack_require__(750))=='object'&&__webpack_require__(750)){// Expose Lodash on the global object to prevent errors when Lodash is
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.getUserSession = exports.validateJwt = exports.validateTokens = exports.authenticateApp = exports.sendWelcomeMessage = exports.removeInstance = exports.editInstance = exports.saveInstance = exports.createIM = exports.addMembership = exports.getList = exports.getInstructions = exports.getParams = exports.getRooms = exports.getUserId = exports.setInstance = exports.getInstance = exports.getAppName = undefined;
	
	var _axios = __webpack_require__(579);
	...
	var hostPort = !port || port.length === 0 ? '' : ':' + port;
	var baseUrl = window.location.protocol + '//' + window.location.hostname + hostPort + '/integration';
	
	var baseWebHookURL = baseUrl + '/v1/whi/' + appName + '/' + configurationId;
	var baseAuthenticationUrl = baseUrl + '/v1/application/' + configurationId + '/jwt';
	var baseAuthorizationUrl = baseUrl + '/v1/application/' + configurationId + '/authorization';
	...
	var sendWelcomeMessage = exports.sendWelcomeMessage = function sendWelcomeMessage(instanceId, streams) {
	  var url = baseWebHookURL + '/' + instanceId + '/welcome';
	  var payload = {
	    streams: streams
	  };
	  _axios2.default.post(url, payload).then(function (data) {
	    return data;
	  }).catch(function (err) {
	    return err;
	  });
	...
	var authenticateApp = exports.authenticateApp = function authenticateApp(podId) {
	  var url = baseAuthenticationUrl + '/authenticate';
	  var payload = {
	    podId: podId
	  };
	...
	var validateTokens = exports.validateTokens = function validateTokens(applicationToken, symphonyToken) {
	  var url = baseAuthenticationUrl + '/tokens/validate';
	  var payload = {
	...
	var validateJwt = exports.validateJwt = function validateJwt(jwt) {
	  var url = baseAuthenticationUrl + '/validate';
	  var payload = {
	    jwt: jwt
	  };
	...
	var getUserSession = exports.getUserSession = function getUserSession(integrationUrl, jwt) {
	  var url = baseAuthorizationUrl + '/userSession';
...
/***/ (function(module, exports) {
	...
	var config = function () {
	  ...
	  pub.setInstructions = function (template) {
	    instructions = template;
	  };
	
	  pub.getInstructions = function () {
	    return instructions;
	  };
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.authorizeUser = exports.getUserJWT = exports.cacheUserInfo = exports.openAuthorizationPopupWindow = undefined;
	
	var _apiCalls = __webpack_require__(751);
	
	var userInfoCache = {};
	
	var openAuthorizationPopupWindow = exports.openAuthorizationPopupWindow = function openAuthorizationPopupWindow(url) {
	  var popup = window.open(url, url, 'toolbar=no,location=no,status=no,menubar=no,scrollbars=no,resizable=no,width=800,height=600');
	  setTimeout(function () {
	...
	var cacheUserInfo = exports.cacheUserInfo = function cacheUserInfo(userInfo) {
	  userInfoCache = Object.assign({}, userInfo);
	};
	
	var getUserJWT = exports.getUserJWT = function getUserJWT() {
	  return Promise.resolve(userInfoCache.jwt);
	};
	
	var authorizeUser = exports.authorizeUser = function authorizeUser(integrationUrl) {
	  getUserJWT().then(function (jwt) {
	    (0, _apiCalls.getUserSession)(integrationUrl, jwt).then(function () {
	      return Promise.resolve(true);
	    }).catch(function (err) {
	      if (err.response.status == 401) {
	        var userSession = err.response;
	        if (userSession.data.properties != null && userSession.data.properties.authorizationUrl != null) {
	          var authorizationUrl = userSession.data.properties.authorizationUrl;
