! function e(t, n, r) {
    ...
    "./src/external-api/symphony-api.js": [function (require, module, exports) {
        ...
        "../../../core": "C:\\dev\\NEXUS\\packages\\core\\src\\index.js",
    ...
    "C:\\dev\\NEXUS\\packages\\applications\\src\\messaging\\listen.js": [function (require, module, exports) {
        ...
        function receiveMessage(event) {
            if (event.data && event.data.command) {
                ...
                if ("hello" === data.command) {
                    var watcher = SYMPHONY.services.subscribe("theme-watcher"),
                        theme = watcher.getTheme();
                    return void 0 === data.sourceName ? void event.source.postMessage({
                        command: "response",
                        status: "FAIL",
                        ...
                        payload: {
                            theme: util.getV1ThemeObject(theme.name, theme.size),
                            themeV2: util.getV2ThemeObject(theme.name, theme.size),
                            pod: env.POD_ID
                        },
                        responseId: data.responseId
                    }, "*"))
                }
                sources[data.sourceName] ? sources[data.sourceName].receive(data, event.origin) : event.source.postMessage({
                    command: "response",
                    status: "FAIL",
                    error: "No source name given",
                    responseId: data.responseId
    ...
    "C:\\dev\\NEXUS\\packages\\core\\src\\eventable.js": [function (require, module, exports) {
        SYMPHONY.eventable = {
    ...
    "C:\\dev\\NEXUS\\packages\\core\\src\\index.js": [function (require, module, exports) {
        ...
        "./eventable.js": "C:\\dev\\NEXUS\\packages\\core\\src\\eventable.js",
        "./registry.js": "C:\\dev\\NEXUS\\packages\\core\\src\\registry.js",
        "./service.js": "C:\\dev\\NEXUS\\packages\\core\\src\\service.js",
        "./start.js": "C:\\dev\\NEXUS\\packages\\core\\src\\start.js",
        "./util": "C:\\dev\\NEXUS\\packages\\core\\src\\util.js"
    }],
    "C:\\dev\\NEXUS\\packages\\core\\src\\registry.js": [function (require, module, exports) {
        (function (global) {
            ...
            SYMPHONY.services = {
                ...
                make: function (serviceName, thing, implementing, eventable, isGlobal) {
                    thing.registryService = SYMPHONY.services.register(serviceName), implementing = implementing || [], implementing.forEach(function (name) {
    ...
    "C:\\dev\\NEXUS\\packages\\core\\src\\service.js": [function (require, module, exports) {
    ...
    "C:\\dev\\NEXUS\\packages\\core\\src\\start.js": [function (require, module, exports) {
        var Q = require("q");
    ...
    "C:\\dev\\NEXUS\\packages\\core\\src\\util.js": [function (require, module, exports) {
        var _ = require("underscore");
        exports.clone = function (value) {
            try {
                return JSON.parse(JSON.stringify(value))
